...
\newcommand{\CVTitle}{Dakota Grusak's CV}
\newcommand{\CVNote}{CV compiled on {\today} for Acme Corporation}
\newcommand{\CVWebpage}{https://dakotagrusak.github.io}
...
\newcommand{\TUEngineeringScienceTitle}{\href{https://new.trinity.edu/academics/departments/engineering-science}{\textbf{Department of Engineering Science}, Trinity University, TX}}

\newcommand{\BMITitle}{\href{https://www.houstonmethodist.org/1285_houstonmethodist/2847_ourresearch/2953_research_ourfaculty/2954_research_labs/research_contreras_vidallab/}{\textbf{Brain-Machine Interface Lab}, Houston, TX}}
...
\begin{Body}
    ...
    % \input{Parts/research-experience.tex}
    % \input{publications.tex}
    % \input{awards-scholarships.tex}
    % \input{affiliations-activities.tex}
    % \input{campus-activities.tex}
    % \input{other-work-experience.tex}
    % \input{languages.tex}
